...
#def authenticate():
	#return Response("Couldn't verify your credentials.  Please try again or contact your Systems Administrator.", 401, {'WWW-Authenticate': 'Basic realm="Login required"'})
